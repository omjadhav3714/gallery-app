...
class _EditProfileViewState extends State<EditProfileView> {
  ...
  void initState() {
    super.initState();
    emailController = TextEditingController(text : widget.data!.data()!.containsKey('email') ?  widget.data!['email']: null);
    nameController = TextEditingController(text : widget.data!.data()!.containsKey('name') ?  widget.data!['name']: null);
    phoneController = TextEditingController(text : widget.data!.data()!.containsKey('phone') ?  widget.data!['phone']: null);
  }
